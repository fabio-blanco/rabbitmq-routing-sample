...
# I don't know why the remote connection is not working
#CMD ./gradlew --no-daemon --no-build-cache -q run --debug-jvm -p consumer
RUN ./gradlew build
...
br/com/globalbyte/samples/rabbit/ps/consumer/ReceiveLogsDirect warning error
